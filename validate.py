...
def main():
    ...
    CLEAN_DIR_IMG ='/content/drive/MyDrive/mini_project/LIDC-IDRI-Preprocessing/data/Clean/Image'
    CLEAN_DIR_MASK ='/content/drive/MyDrive/mini_project/LIDC-IDRI-Preprocessing/data/Clean/Mask'
    clean_meta = pd.read_csv('/content/drive/MyDrive/mini_project/LIDC-IDRI-Preprocessing/data/Meta/clean_meta.csv')
